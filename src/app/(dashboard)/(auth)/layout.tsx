        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <span className="text-[#1E293B] text-lg">Certified organic farmers</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#4ADE80] flex items-center justify-center mt-0.5">
                <Check className="h-4 w-4 text-white" />
              </div>
              <span className="text-[#1E293B] text-lg">Refund or replacement for defects</span>
            </div>
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 w-6 h-6 rounded-full bg-[#4ADE80] flex items-center justify-center mt-0.5">
                <Check className="h-4 w-4 text-white" />
              </div>
              <span className="text-[#1E293B] text-lg">99.8% issue-free delivery</span>
            </div>
          </div>
        </div>
      </div>
